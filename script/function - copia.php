<?php
	...
	function cc_menu($pag)
	{
		...
		if($page[0]=="administracion")
		{
			...
			if($_SESSION['rol']==1)
			{
				...
				if(count($entidad)!=0)
				{
					...
					{
						for($j=0;$j<$entidad.length;$j++)
						{
							$empresax = $empresax.'<option value="'.$entidad[$j] ['id_ent'].'">'.$entidad[$j] ['nom_ent'].'</option>';
						}
					}
		...
		else
		{
			...
			if($page[1]=="" || $page[0]!="servicios")
			{
				...
				{
					echo '<li><a class="myButton" href="'.WEB_BASE.'servicios/'.$categorias [$i] ['nom_cat'].'/Todos">'.$categorias [$i] ['nom_cat'].'</a></li>';
				}
			}
			else
			{
				...
				for($i=0;$i<count($categorias);$i++)
				{
					...
					echo '<li><a class="myButton" href="'.WEB_BASE.'">'.$categorias [$i] ['nom_cat'].'</a></li>';
				}
			...
			if($page[1]!="" && $page[0]=="servicios")
			{
				...
				if($page[2]=="Todos")
				{
					...
					{
						echo '<li><a style="background: red;" class="myButton" href="'.WEB_BASE.'servicios/'.$page[1].'/'.$subcategorias[$i]['nom_scat'].'/'.$page[3].'">'.$subcategorias [$i] ['nom_scat'].'</a></li>';
					}
				}
				else
				{
					$arg=array('nom_scat'=>$page[2]);
					//print_r($arg);
					$subcategorias=$transaccion->listarSubcategorias($arg);
					//print_r($subcategorias);
					for($i=0;$i<count($subcategorias);$i++)
					{
						...
						echo '<li><a style="background: red;" class="myButton" href="'.WEB_BASE.'servicios/'.$page[1].'/Todos/'.$page[3].'">'.$subcategorias[$i]['nom_scat'].'</a></li>';
					}
					//echo '<li><a style="background: green;" class="myButton" href="http://www.contratoenchile.cl/servicios/'.$page[1].'/'.$page[2].'/">Volver</a></li>';
				}
				if($page[3]=="")
				{
					...
					{
						echo '<li><a style="background: green;" class="myButton" href="'.WEB_BASE.'servicios/'.$page[1].'/'.$page[2].'/'.$tp[$i]['nom_ts'].'">'.$tp [$i] ['nom_ts'].'</a></li>';
					}
				}
				else
				{
					...
					for($i=0;$i<count($tp);$i++)
					{
						echo '<li><a style="background: green;" class="myButton" href="'.WEB_BASE.'servicios/'.$page[1].'/'.$page[2].'">'.$tp [$i] ['nom_ts'].'</a></li>';
					}
					//echo '<li><a style="background: green;" class="myButton" href="'.WEB_BASE.'servicios/'.$page[1].'/'.$page[2].'/">Volver</a></li>';
				}
			}
			//print_r($categorias);
	...
	function escribirLog($pagina)
	{
		...
		$registro=$fecha."|".$proxy."|".$page."|".$rol."|".$rut."\n";
