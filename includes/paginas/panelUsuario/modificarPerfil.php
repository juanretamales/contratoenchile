	...
	<form method="post" class="formulario" id="empresa" onsubmit="return modificarPerfil()">
		...
		<?php
			require_once "script/webConfig.php";
				...
				<div>
					<img title="Captcha" id="Captcha" onclick="actualizarCaptcha()"	src="<?php echo WEB_BASE; ?>script/captcha/captcha.php" />
				</div>
				<div>
					<label>Captcha:</label>
				...
				<div>
					<input class="boton submit" type="submit" value="Modificar Perfil">
