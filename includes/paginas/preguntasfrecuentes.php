	...
	<body>
		...
		<section id="contenido" >
			...
			<article id="6" class="servicios">
				¿Cómo respondo a un contacto? <br>En tus contratos, debes ir a mensajes, alli estaras en una conversacion con la empresa.
			</article>
			<article id="7" class="servicios">
				¿Qué es una Tienda y cuanto cuesta? <br>Una tienda dentro de Contrato en Chile es la pagina personal de la empresa registrada, esta la opcion basica que es gratuita, y la opcion completa que es por subscripcion
			</article>
