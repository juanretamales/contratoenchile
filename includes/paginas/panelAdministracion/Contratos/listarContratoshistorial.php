...
<?php 
			require_once "script/webConfig.php";
					...
					?>
			<h1 class="titulo">Historial de Contratos</h1>
			...
			<table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable">
				<thead>
					<tr>
						...
						<th><h3>Empresa</h3></th>
						<th><h3>Persona</h3></th>
						<th colspan="7" class="nosort"><h3>Accion</h3></th>
					</tr>
				</thead>
				<tbody>
			<?php
							...
							{
								switch($contratos [$i] ['id_est'])
								{
									case 7:
										echo '<tr style="background-color: #82FA58;">';
										break;
									case 8:
										echo '<tr style="background-color: #FE2E64;">';
										break;
									case 9:
										echo '<tr style="background-color: #0040FF;">';
										break;
									case 10:
										echo '<tr style="background-color: #FE9A2E;">';
										break;
									case 11:
					...
					<img title="ver detalles" width="20px" src="<?php echo WEB_BASE; ?>imagenes/UI/ver.png">
					</a></td>
					<td><a onclick="verMensajes(<?php echo $contratos [$i] ['id_con']; ?>)">
					<img title="ver mensajes" width="20px" src="<?php echo WEB_BASE; ?>imagenes/UI/mensajes.png">
					</a></td>
					...
					<td><a onclick="finalizarContacto(<?php echo $contratos [$i] ['id_con']; ?>, '<?php echo $contratos [$i] ['nom_ent'].' con '.$contratos [$i] ['nombre']." ".$contratos [$i] ['apellido']; ?>')">
						<img title="Finalizar" width="20px" src="<?php echo WEB_BASE;?>imagenes/UI/contrato.png">
					</a></td>
					<td><a onclick="calificarContacto(<?php echo $contratos [$i] ['id_con']; ?>, '<?php echo $contratos [$i] ['nom_ent'].' con '.$contratos [$i] ['nombre']." ".$contratos [$i] ['apellido']; ?>')">
						<img title="Calificar" width="20px" src="<?php echo WEB_BASE;?>imagenes/UI/modificar.png">
					</a></td>
					<td><a onclick="borrarContacto(<?php echo $contratos [$i] ['id_con']; ?>, '<?php echo $contratos [$i] ['nom_ent'].' con '.$contratos [$i] ['nombre']." ".$contratos [$i] ['apellido']; ?>')">
