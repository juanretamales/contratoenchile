...
<section id="contenido">
	<form class="formulario" onsubmit="return agregarTipoCod()" method="post">
		<div id="error"></div>
			...
			<div>
				<label>Sigla</label>
				<input required x-moz-errormessage="Debe ingresar el nombre " type="text" required maxlength="255" id="txtSigla" name="txtSigla">
				<img src="<?php echo WEB_BASE; ?>imagenes/none.png" id="imgSigla">
			</div>
			<div>
