...
if(isset($_REQUEST['pagina']))
{
	...
	<section id="contenido" >
			...
			<h1 class="titulo">Metricas de calificacion</h1>
	...
	<div id="error"></div>
			...
			<?php
							...
							$arg=array ('nada'=>0);
							$ec=listarEscalacal($ec);
							for($i=0;$i<count($ec);$i++)
							{
								?>
				<tr>
					<td><?php echo $ec [$i] ['nom_ec']; ?></td>
					<td><?php echo $ec [$i] ['valor']; ?></td>
					<td><a onclick="modificar(<?php echo $ec [$i] ['id_ec']; ?>)">
						<img title="Modificar" width="20px" src="<?php echo WEB_BASE; ?>imagenes/UI/modificar.png">
					</a></td>
					<td><a onclick="eliminarMetrica(<?php echo $ec [$i] ['id_ec']; ?>, '<?php echo $ec [$i] ['nom_ec']; ?>')">
