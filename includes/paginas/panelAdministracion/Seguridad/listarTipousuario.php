...
if(isset($_REQUEST['pagina']))
{
	...
	<section id="contenido" >
			...
			<h1 class="titulo">Tipo de usuario</h1>
			<a class="boton"  href="<?php echo WEB_BASE; ?>administracion/seguridad/tipousuario/agregar">Agregar</a>
			<form id="frmModificar" method="post" name="frmModificar" action="<?php echo WEB_BASE; ?>administracion/seguridad/tipousuario/modificar">
		...
		<div id="error"></div>
			...
			<?php
							...
							for($i=0;$i<count($tu);$i++)
							{
								?>
				<tr>
					<td><?php echo $tu [$i] ['id_tu']; ?></td>
					<td><?php echo $tu [$i] ['nom_tu']; ?></td>
					<td><a onclick="modificar(<?php echo $tu [$i] ['id_tu']; ?>)">
						<img title="Modificar" width="20px" src="<?php echo WEB_BASE; ?>imagenes/UI/modificar.png">
					</a></td>
					<td><a onclick="eliminarTipousuario(<?php echo $tu [$i] ['id_tu']; ?>, '<?php echo $tu [$i] ['nom_tu']; ?>')">
