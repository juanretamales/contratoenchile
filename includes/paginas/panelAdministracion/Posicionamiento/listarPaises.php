			...
			<table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable">
				...
				<?php
								...
								for($i=0;$i<count($paises);$i++)
								{
									?>
					<tr>
						<td><?php echo $paises [$i] ['id_pais']; ?></td>
						<td><?php echo $paises [$i] ['nom_pais']; ?></td>
						<td><a onclick="modificar(<?php echo $paises [$i] ['id_pais']; ?>)">
							<img title="Modificar" width="20px" src="<?php echo WEB_BASE; ?>imagenes/UI/modificar.png">
						</a></td>
						<td><a onclick="eliminarPais(<?php echo $paises [$i] ['id_pais']; ?>, '<?php echo $paises [$i] ['nom_pais']; ?>')">
