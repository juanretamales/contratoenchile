<html lang="es" dir="LTR" >
  ...
  fjs.parentNode.insertBefore(js, fjs);
		...
		?>		<label class="titulo"><?php echo $servicios [0] ['nom_serv'] . ' de ' . $servicios [0] ['nom_ent']; ?></label>
			<article class="detalle">												<!--<div class="tipo">					<a><?php echo $servicios [0] ['nom_scat']; ?></a>					<a><?php echo $servicios [0] ['nom_ts']; ?></a>				</div>-->												<?php						if(isset($_SESSION['rol']))						{							if($_SESSION['rol']>0)							{					?>					<div class="botones">						<a class="boton carro" onclick="agregarAlCarro(<?php echo $servicios [0] ['id_serv']; ?>)" class="canasta"><em class="agregar"></em><em class="canasta"></em><label>Agregar a Canasta</label></a>						<a class="boton comparacion" onclick="agregarAComparacion(<?php echo $servicios [0] ['id_serv']; ?>)" class="comparar"><em class="agregar"></em><em class="comparacion"></em><label>Agregar a Comparacion</label></a>					</div>					<?php							} 						}					?>								<div id="descripcion">					<?php echo urldecode($servicios [0] ['desc_serv']); ?>				</div>				<div id="reputacion">
