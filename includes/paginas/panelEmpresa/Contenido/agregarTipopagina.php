...
if(isset($_REQUEST['pagina']))
{
	...
	<form class="formulario" action="../../../script/transicion.php"  method="post">
				<p>Añadir nuevo Tipo de Pagina</p>
				<div>
					<label>Nombre del Tipo de Pagina</label>
					<input required x-moz-errormessage="Debe ingresar el nombre del Tipo de Pagina" type="text" name="txtNombre" maxlength="255">
				</div>
				<div>
					<input type="submit" name="btnRegistrarTipopag" value="Añadir Tipo de Pagina">
				</div>
				<a href="http://www.contratoenchile.cl/administracion/contenido/tipopagina">Cancelar</a>
	</form>
</section>
	<?php cc_footer(); ?>
</body>
