	...
	<form class="formulario" action="../../../script/transicion.php"  method="post">
				...
				<div>
					...
					<?php
							...
							{
								?>
					<option value="<?php echo $tp [$i] ['id_tm']; ?>"><?php echo $tp [$i] ['nom_tm']; ?></option>
				<?php } ?>
				</div>
				<div>
					<label>Empresa</label>
				...
				<div>
					<label>URL del Multimedia</label>
					<input required x-moz-errormessage="Debe ingresar el nombre del Documento" type="text" name="txtNombre" maxlength="255">
				</div>
				<div>
					<input type="submit" name="btnRegistrarMultimedia" value="Añadir  Multimedia">
				</div>
