...
if(isset($_REQUEST['pagina']))
{
	...
	<section id="contenido" >
			...
			<a class="myButton" style="width: 50px;" href="http://www.contratoenchile.cl/administracion/contenido/tipodocumento/agregar">Agregar</a>
			...
			<?php
							...
							$arg=array ('nada'=>0);
							$doc=listarTipodoc($arg);
							for($i=0;$i<count($doc);$i++)
							{
								?>
				<tr>
					<td><?php echo $doc [$i] ['id_td']; ?></td>
					<td><?php echo $doc [$i] ['nom_td']; ?></td>
					<td><a href="http://www.contratoenchile.cl/<?php echo $doc [$i] ['id_td']; ?>">Modificar</a></td>
					<td><a onclick="eliminar(<?php echo $doc [$i] ['id_td']; ?>, '<?php echo $doc [$i] ['nom_td']; ?>')">Eliminar</a></td>
				</tr>
				<?php } ?>
			</table>
</section>
